# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Create template file for Project table
# Author: Amanda Droghini, Alaska Center for Conservation Science
# Last Updated: 2024-07-29
# Usage: Should be executed in R 4.4.1+.
# Description: "Create template file for Project table" reads in a .R script file and replaces values as specified in a CSV configuration file. The output is a .R script file with appropriate file paths and project code values that can then be modified for data ingestion needs.
...
# Define input files
template_file = file.path(repository_folder, "package_DataProcessing/template_01_project.R")
...
# Define output
output_file = paste(project_name, "01_project.R", sep = "_")
