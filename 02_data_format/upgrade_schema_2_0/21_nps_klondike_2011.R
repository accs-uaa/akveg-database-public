...
# Define project
project_folder = '21_nps_klondike_2011'

# Define input data files
site_input = 'npsKlondikeLC_2011_Site.xlsx'
cover_input = 'npsKlondikeLC_2011_Cover.xlsx'
environment_input = 'npsKlondikeLC_2011_Environment.xlsx'

# Define output data files
site_output = '02_site_npsklondike2011'
site_visit_output = '03_sitevisit_npsklondike2011'
cover_output = '05_vegetationcover_npsklondike2011'
environment_output = '12_environment_npsklondike2011'
output_list = c(site_output, site_visit_output, cover_output, environment_output)
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'nps_klondike_2011') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  # Correct errors
  mutate(project_code = 'nps_klondike_2011') %>%
  mutate(scope_bryophyte = 'common species') %>%
  mutate(scope_lichen = 'common species') %>%
...
table_list = list(site_data, site_visit_data, cover_join, environment_data)
