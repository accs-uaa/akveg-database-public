# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Parse ACCS Nuyakuk 2019 upload from schema 1.0 to 2.0
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Last Updated: 2022-10-13
# Usage: Script should be executed in R 4.0.0+.
# Description: "Parse ACCS Nuyakuk 2019 data from schema 1.0 to 2.0" updates the data from the 1.0 to 2.0 AKVEG Database schema format. New fields are added as necessary to match VTWG Minimum Standards per data tier and NODATA values are enforced.
# ---------------------------------------------------------------------------
...
# Define project
project_folder = '17_accs_nuyakuk_2019'

# Define input data files
site_input = 'accsNuyakuk_2019_Site.xlsx'
cover_input = 'accsNuyakuk_2019_Cover.xlsx'

# Define output data files
site_output = '02_site_accsnuyakuk2019'
site_visit_output = '03_sitevisit_accsnuyakuk2019'
cover_output = '05_vegetationcover_accsnuyakuk2019'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'accs_nuyakuk_2019') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  mutate(env_observer = 'Timm Nawrocki') %>%
  ...
  # Correct project code
  mutate(project_code = 'accs_nuyakuk_2019') %>%
