...
# Define project
project_folder = '06_nps_yukon_2003'

# Define input data files
site_input = 'npsYukonCharleyPA_2003_Site.xlsx'
cover_input = 'npsYukonCharleyPA_2003_Cover.xlsx'
environment_input = 'npsYukonCharleyPA_2003_Environment.xlsx'

# Define output data files
site_output = '02_site_npsyukon2003'
site_visit_output = '03_sitevisit_npsyukon2003'
cover_output = '05_vegetationcover_npsyukon2003'
environment_output = '12_environment_npsyukon2003'
soils_output = '13_soils_npsyukon2003'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'nps_yukon_2003') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  mutate(soils_observer = case_when(soil_ph_10 > 0 | water_ph > 0 ~ env_observer,
                                    TRUE ~ 'NULL')) %>%
  ...
  # Correct errors
  mutate(project_code = 'nps_yukon_2003') %>%
