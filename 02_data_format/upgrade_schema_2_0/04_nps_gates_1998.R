# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Parse NPS Gates 1998 upload from schema 1.0 to 2.0
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Last Updated: 2022-10-13
# Usage: Script should be executed in R 4.0.0+.
# Description: "Parse NPS Gates 1998 data from schema 1.0 to 2.0" updates the data from the 1.0 to 2.0 AKVEG Database schema format. New fields are added as necessary to match VTWG Minimum Standards per data tier and NODATA values are enforced. Duplicate vegetation cover entries are aggregated as the sum.
# ---------------------------------------------------------------------------
...
# Define project
project_folder = '04_nps_gates_1998'

# Define input data files
site_input = 'npsGatesLC_1998_Site.xlsx'
cover_input = 'npsGatesLC_1998_Cover.xlsx'
environment_input = 'npsGatesLC_1998_Environment.xlsx'

# Define output data files
site_output = '02_site_npsgates1998'
site_visit_output = '03_sitevisit_npsgates1998'
cover_output = '05_vegetationcover_npsgates1998'
environment_output = '12_environment_npsgates1998'
soils_output = '13_soils_npsgates1998'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'nps_gates_1998') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  # Correct errors
  mutate(project_code = 'nps_gates_1998') %>%
