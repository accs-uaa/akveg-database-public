# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Parse NPS Katmai 2000 upload from schema 1.0 to 2.0
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Last Updated: 2022-10-13
# Usage: Script should be executed in R 4.0.0+.
# Description: "Parse NPS Katmai 2000 data from schema 1.0 to 2.0" updates the data from the 1.0 to 2.0 AKVEG Database schema format. New fields are added as necessary to match VTWG Minimum Standards per data tier and NODATA values are enforced. Duplicate vegetation cover entries are aggregated as the sum.
# ---------------------------------------------------------------------------
...
# Define project
project_folder = '14_nps_katmai_2000'

# Define input data files
site_input = 'npsKatmaiLC_2000_Site.xlsx'
cover_input = 'npsKatmaiLC_2000_Cover.xlsx'
environment_input = 'npsKatmaiLC_2000_Environment.xlsx'

# Define output data files
site_output = '02_site_npskatmai2000'
site_visit_output = '03_sitevisit_npskatmai2000'
cover_output = '05_vegetationcover_npskatmai2000'
environment_output = '12_environment_npskatmai2000'
soils_output = '13_soils_npskatmai2000'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'nps_katmai_2000') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  mutate(soils_observer = case_when(soil_ph_10 > 0 ~ env_observer,
                                    TRUE ~ 'NULL')) %>%
  ...
  # Correct errors
  mutate(project_code = 'nps_katmai_2000') %>%
