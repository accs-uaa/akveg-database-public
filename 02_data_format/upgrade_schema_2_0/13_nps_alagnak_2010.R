# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Parse NPS Alagnak 2010 upload from schema 1.0 to 2.0
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Last Updated: 2022-10-13
# Usage: Script should be executed in R 4.0.0+.
# Description: "Parse NPS Alagnak 2010 data from schema 1.0 to 2.0" updates the data from the 1.0 to 2.0 AKVEG Database schema format. New fields are added as necessary to match VTWG Minimum Standards per data tier and NODATA values are enforced. Duplicate vegetation cover entries are aggregated as the sum.
# ---------------------------------------------------------------------------
...
# Define project
project_folder = '13_nps_alagnak_2010'

# Define input data files
site_input = 'npsAlagnakLC_2010_Site.xlsx'
cover_input = 'npsAlagnakLC_2010_Cover.xlsx'
environment_input = 'npsAlagnakLC_2010_Environment.xlsx'

# Define output data files
site_output = '02_site_npsalagnak2010'
site_visit_output = '03_sitevisit_npsalagnak2010'
cover_output = '05_vegetationcover_npsalagnak2010'
environment_output = '12_environment_npsalagnak2010'
soils_output = '13_soils_npsalagnak2010'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'nps_alagnak_2010') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  mutate(soils_observer = case_when(soil_ph_10 > 0 | water_ph > 0 ~ 'Chuck Lindsay',
                                    TRUE ~ 'NULL')) %>%
  ...
  # Correct errors
  mutate(project_code = 'nps_alagnak_2010') %>%
