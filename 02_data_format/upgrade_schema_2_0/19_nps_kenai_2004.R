...
# Define project
project_folder = '19_nps_kenai_2004'

# Define input data files
site_input = 'npsKenaiFjordsLC_2004_Site.xlsx'
cover_input = 'npsKenaiFjordsLC_2004_Cover.xlsx'

# Define output data files
site_output = '02_site_npskenai2004'
site_visit_output = '03_sitevisit_npskenai2004'
cover_output = '05_vegetationcover_npskenai2004'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'nps_kenai_2004') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  mutate(scope_lichen = case_when(perspective == 'ground' ~ 'partial',
                                  ...
                                  TRUE ~ 'NULL')) %>%
  # Correct project code
  mutate(project_code = 'nps_kenai_2004') %>%
