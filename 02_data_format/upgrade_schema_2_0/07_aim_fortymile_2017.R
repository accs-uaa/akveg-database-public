# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Parse AIM Fortymile 2017 upload from schema 1.0 to 2.0
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Last Updated: 2022-10-13
# Usage: Script should be executed in R 4.0.0+.
# Description: "Parse AIM Fortymile 2017 data from schema 1.0 to 2.0" updates the data from the 1.0 to 2.0 AKVEG Database schema format. New fields are added as necessary to match VTWG Minimum Standards per data tier and NODATA values are enforced.
# ---------------------------------------------------------------------------
...
# Define project
project_folder = '07_aim_fortymile_2017'

# Define input data files
site_input = 'aimFortymile_2017_Site.xlsx'
cover_input = 'aimFortymile_2017_Cover.xlsx'
environment_input = 'aimFortymile_2017_Environment.xlsx'

# Define output data files
site_output = '02_site_aimfortymile2017'
site_visit_output = '03_sitevisit_aimfortymile2017'
cover_output = '05_vegetationcover_aimfortymile2017'
environment_output = '12_environment_aimfortymile2017'
soils_output = '13_soils_aimfortymile2017'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'aim_fortymile_2017') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  # Correct errors
  mutate(project_code = 'aim_fortymile_2017') %>%
