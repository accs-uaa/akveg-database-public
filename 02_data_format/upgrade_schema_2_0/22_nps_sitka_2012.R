# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Parse NPS Sitka 2012 upload from schema 1.0 to 2.0
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Last Updated: 2022-10-13
# Usage: Script should be executed in R 4.0.0+.
# Description: "Parse NPS Sitka 2012 data from schema 1.0 to 2.0" updates the data from the 1.0 to 2.0 AKVEG Database schema format. New fields are added as necessary to match VTWG Minimum Standards per data tier and NODATA values are enforced. Duplicate vegetation cover entries are aggregated as the sum.
# ---------------------------------------------------------------------------
...
# Define project
project_folder = '22_nps_sitka_2012'

# Define input data files
site_input = 'npsSitkaLC_2012_Site.xlsx'
cover_input = 'npsSitkaLC_2012_Cover.xlsx'

# Define output data files
site_output = '02_site_npssitka2012'
site_visit_output = '03_sitevisit_npssitka2012'
cover_output = '05_vegetationcover_npssitka2012'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'nps_sitka_2012') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  # Correct errors
  mutate(project_code = 'nps_sitka_2012') %>%
