# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Parse ACCS Colville 2015 upload from schema 1.0 to 2.0
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Last Updated: 2022-10-13
# Usage: Script should be executed in R 4.0.0+.
# Description: "Parse ACCS Colville 2015 data from schema 1.0 to 2.0" updates the data from the 1.0 to 2.0 AKVEG Database schema format. New fields are added as necessary to match VTWG Minimum Standards per data tier and NODATA values are enforced.
# ---------------------------------------------------------------------------
...
# Define project
project_folder = '02_accs_colville_2015'

# Define input data files
site_input = 'accsColville_2015_Site.xlsx'
cover_input = 'accsColville_2015_Cover.xlsx'

# Define output data files
site_output = '02_site_accscolville2015'
site_visit_output = '03_sitevisit_accscolville2015'
cover_output = '05_vegetationcover_accscolville2015'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'accs_colville_2015') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  mutate(env_observer = 'Lindsey Flagstad') %>%
  mutate(soils_observer = 'Lindsey Flagstad') %>%
  # Correct project code
  mutate(project_code = 'accs_colville_2015') %>%
