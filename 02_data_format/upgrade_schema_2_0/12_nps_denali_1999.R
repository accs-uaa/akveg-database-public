# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Parse NPS Denali 1999 upload from schema 1.0 to 2.0
# Author: Timm Nawrocki, Alaska Center for Conservation Science
# Last Updated: 2022-10-13
# Usage: Script should be executed in R 4.0.0+.
# Description: "Parse NPS Denali 1999 data from schema 1.0 to 2.0" updates the data from the 1.0 to 2.0 AKVEG Database schema format. New fields are added as necessary to match VTWG Minimum Standards per data tier and NODATA values are enforced. Duplicate vegetation cover entries are aggregated as the sum.
# ---------------------------------------------------------------------------
...
# Define project
project_folder = '12_nps_denali_1999'

# Define input data files
site_input = 'npsDenaliLC_1999_Site.xlsx'
cover_input = 'npsDenaliLC_1999_Cover.xlsx'
environment_input = 'npsDenaliLC_1999_Environment.xlsx'

# Define output data files
site_output = '02_site_npsdenali1999'
site_visit_output = '03_sitevisit_npsdenali1999'
cover_output = '05_vegetationcover_npsdenali1999'
environment_output = '12_environment_npsdenali1999'
soils_output = '13_soils_npsdenali1999'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'nps_denali_1999') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  # Correct errors
  mutate(project_code = 'nps_denali_1999') %>%
