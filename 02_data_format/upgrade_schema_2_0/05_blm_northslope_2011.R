...
# Define project
project_folder = '05_blm_northslope_2011'

# Define input data files
site_input = 'northSlopeLC_2011_Site.xlsx'
cover_input = 'northSlopeLC_2011_Cover.xlsx'

# Define output data files
site_output = '02_site_blmnorthslope2011'
site_visit_output = '03_sitevisit_blmnorthslope2011'
cover_output = '05_vegetationcover_blmnorthslope2011'
...
site_data = site_original %>%
  ...
  mutate(establishing_project = 'blm_northslope_2011') %>%
  # Select final fields
...
site_visit_data = cover_original %>%
  ...
  mutate(project_code = 'blm_northslope_2011') %>%
