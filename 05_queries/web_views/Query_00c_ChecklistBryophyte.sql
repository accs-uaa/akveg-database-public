-- -*- coding: utf-8 -*-
-- ---------------------------------------------------------------------------
-- Query bryophyte checklist web view
-- Author: Timm Nawrocki, Alaska Center for Conservation Science
-- Last Updated:  2022-10-18
-- Usage: Script should be executed in a PostgreSQL 14+ database.
-- Description: "Query bryophyte checklist web view" queries the bryophyte taxa in a web checklist format.
-- ---------------------------------------------------------------------------
...
WHERE taxon_level.taxon_level IN ('genus', 'hybrid', 'species', 'subspecies', 'variety')
  AND taxon_category.taxon_category IN ('hornwort', 'liverwort', 'moss')
